    ...
    public class DbInitializer
    {
        ...
        #pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
            ...
            if (_context.Groups.Count() == 0)
            {
                ...
                {
                    new Group(){GroupCode="GG",GroupName="GG",CreatedBy=_configuration["Auto:Create"]},
                    new Group(){GroupCode="VG",GroupName="VG",CreatedBy=_configuration["Auto:Create"]},
                    new Group(){GroupCode="GD",GroupName="GD",CreatedBy=_configuration["Auto:Create"]},
                    new Group(){GroupCode="MD",GroupName="MD",CreatedBy=_configuration["Auto:Create"]},
                    new Group(){GroupCode="BG",GroupName="BG",CreatedBy=_configuration["Auto:Create"]},
                    new Group(){GroupCode="BA",GroupName="BA",CreatedBy=_configuration["Auto:Create"]},
                    new Group(){GroupCode="DF",GroupName="DF",CreatedBy=_configuration["Auto:Create"]},
                };
