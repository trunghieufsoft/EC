...
namespace WebApi.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        [HttpPost]
        [Route("CreateDriver")]
        public IActionResult CreateDriver([FromBody] DriverInput requestDto)
        {
            _sessionService.CheckSession(GetToken(), GetCurrentUser());
            var data = _userService.CreateDriver(new DataInput<DriverInput>(requestDto, GetCurrentUser()));
            return Json(data);
        }
        ...
        [HttpPost]
        [Route("UpdateDriver")]
        public IActionResult UpdateDriver([FromBody] DriverUpdateInput requestDto)
        {
            _sessionService.CheckSession(GetToken(), GetCurrentUser());
            _userService.Update(new UpdateInput(requestDto, GetCurrentUser()));
            return Json(success);
        ...
        [HttpPost]
        [Route("Search/Driver")]
        public IActionResult SearchDriver([FromBody] SearchInput searchInput)
        {
            _sessionService.CheckSession(GetToken(), GetCurrentUser());
            var requestDto = new DataInput<SearchInput>()
            {
            ...
            return Json(_userService.SearchDriver(requestDto));
        }
        ...
        private string GenerateJSONWebToken(UserOutput userInfo)
        {
            ...
            string Country = userInfo.CountryId ?? "ALL";
