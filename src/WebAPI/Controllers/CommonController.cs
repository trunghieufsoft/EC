...
namespace WebAPI.Controllers
{
    ...
    public class CommonController : BaseController
    {
        ...
        public IActionResult GetUsersAllTypeAssignByCountry(string userType, string country = null)
        {
            ...
            UserTypeEnum type = (userType.Equals(UserTypeEnum.SuperAdmin.ToString()) || userType.Equals(UserTypeEnum.Manager.ToString()) || userType.Equals(UserTypeEnum.Staff.ToString()) || userType.Equals(UserTypeEnum.Driver.ToString()))
