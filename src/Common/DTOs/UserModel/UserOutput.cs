...
namespace Common.DTOs.UserModel
{
    ...
    {
        public CountTotalUsers(int manager = 0, int staff = 0, int Driver = 0)
        {
            Manager = manager;
            Staff = staff;
            Driver = Driver;
    ...
    public class UserOutput
    {
        public UserOutput(User user, Group group = null)
        {
            ...
            StatusDetail = !user.UserType.Equals(UserTypeEnum.Driver) ? null : new Status(user.Status, user.EndOfDay);
